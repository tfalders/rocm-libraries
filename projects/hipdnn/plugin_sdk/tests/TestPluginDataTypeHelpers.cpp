...
TEST(TestPluginDataTypeHelpers, ToStringPluginStatus)
{
    ...
    EXPECT_STREQ(toString(HIPDNN_PLUGIN_STATUS_NOT_APPLICABLE),
                 "HIPDNN_PLUGIN_STATUS_NOT_APPLICABLE");
    EXPECT_STREQ(toString(HIPDNN_PLUGIN_STATUS_NOT_INITIALIZED),
...
TEST(TestPluginDataTypeHelpers, ToStringPluginType)
{
    ...
    EXPECT_STREQ(toString(HIPDNN_PLUGIN_TYPE_HEURISTIC), "HIPDNN_PLUGIN_TYPE_HEURISTIC");
